...
<!-- CAN GO (because it is moved to GLOSSARY.md):
>Key domain terms:
...
<!--> Needs Updating (how do we solve ongoing updates?)
...
<!-- Complete overhaul with new "## ## 5. Workflow"
## Agent Roles
...
<!-- This can go / needs serious updating:
