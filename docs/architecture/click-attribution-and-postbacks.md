...
- schema migration consolidates existing main-summary rows onto the slim hash/dimension contract before dropping retired columns; no automatic historical raw-source full backfill is implied
