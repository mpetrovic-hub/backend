...
- existing summary rows outside refreshed windows keep their previous hash/dimension contract until their day is recomputed; no automatic historical full backfill is implied
