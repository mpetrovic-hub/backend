...
return [
    ...
    Kiwi_Database_Table_Names::LANDING_SESSION_ENGAGEMENTS => [
        ...
        'column_metadata' => [
            ...
            'provider_key' => ['type' => 'varchar(50)', 'nullable' => false, 'default' => '', 'extra' => ''],
            'service_key' => ['type' => 'varchar(100)', 'nullable' => false, 'default' => '', 'extra' => ''],
            'flow_key' => ['type' => 'varchar(50)', 'nullable' => false, 'default' => '', 'extra' => ''],
            'pid' => ['type' => 'varchar(191)', 'nullable' => false, 'default' => '', 'extra' => ''],
            'click_id' => ['type' => 'varchar(191)', 'nullable' => false, 'default' => '', 'extra' => ''],
            'tksource' => ['type' => 'varchar(191)', 'nullable' => false, 'default' => '', 'extra' => ''],
            'tkzone' => ['type' => 'varchar(191)', 'nullable' => false, 'default' => '', 'extra' => ''],
            'landing_key' => ['type' => 'varchar(100)', 'nullable' => false, 'default' => '', 'extra' => ''],
            'session_token' => ['type' => 'varchar(150)', 'nullable' => false, 'default' => '', 'extra' => ''],
            'page_loaded_at' => ['type' => 'datetime', 'nullable' => true, 'default' => null, 'extra' => ''],
            'first_cta_click_at' => ['type' => 'datetime', 'nullable' => true, 'default' => null, 'extra' => ''],
            'last_cta_click_at' => ['type' => 'datetime', 'nullable' => true, 'default' => null, 'extra' => ''],
            'cta_click_count' => ['type' => 'int unsigned', 'nullable' => false, 'default' => '0', 'extra' => ''],
            'first_cta1_click_at' => ['type' => 'datetime', 'nullable' => true, 'default' => null, 'extra' => ''],
            'last_cta1_click_at' => ['type' => 'datetime', 'nullable' => true, 'default' => null, 'extra' => ''],
            'cta1_click_count' => ['type' => 'int unsigned', 'nullable' => false, 'default' => '0', 'extra' => ''],
            'first_cta2_click_at' => ['type' => 'datetime', 'nullable' => true, 'default' => null, 'extra' => ''],
            'last_cta2_click_at' => ['type' => 'datetime', 'nullable' => true, 'default' => null, 'extra' => ''],
            'cta2_click_count' => ['type' => 'int unsigned', 'nullable' => false, 'default' => '0', 'extra' => ''],
            'first_cta3_click_at' => ['type' => 'datetime', 'nullable' => true, 'default' => null, 'extra' => ''],
            'last_cta3_click_at' => ['type' => 'datetime', 'nullable' => true, 'default' => null, 'extra' => ''],
            'cta3_click_count' => ['type' => 'int unsigned', 'nullable' => false, 'default' => '0', 'extra' => ''],
            'ua_ch_supported' => ['type' => 'tinyint(1)', 'nullable' => false, 'default' => '0', 'extra' => ''],
            'ua_ch_mobile' => ['type' => 'tinyint(1)', 'nullable' => false, 'default' => '0', 'extra' => ''],
            'ua_ch_platform' => ['type' => 'varchar(50)', 'nullable' => false, 'default' => '', 'extra' => ''],
            'ua_ch_platform_version' => ['type' => 'varchar(50)', 'nullable' => false, 'default' => '', 'extra' => ''],
            'ua_ch_model' => ['type' => 'varchar(191)', 'nullable' => false, 'default' => '', 'extra' => ''],
            'ua_ch_brands' => ['type' => 'text', 'nullable' => true, 'default' => null, 'extra' => ''],
            'ua_ch_full_version_list' => ['type' => 'text', 'nullable' => true, 'default' => null, 'extra' => ''],
            'user_agent' => ['type' => 'text', 'nullable' => true, 'default' => null, 'extra' => ''],
            'last_event_at' => ['type' => 'datetime', 'nullable' => false, 'default' => null, 'extra' => ''],
            'is_soft_flag' => ['type' => 'tinyint(1)', 'nullable' => false, 'default' => '0', 'extra' => ''],
            'soft_flag_reason' => ['type' => 'varchar(191)', 'nullable' => false, 'default' => '', 'extra' => ''],
            'soft_flag_rule_key' => ['type' => 'varchar(100)', 'nullable' => false, 'default' => '', 'extra' => ''],
            'soft_flag_evaluated_at' => ['type' => 'datetime', 'nullable' => true, 'default' => null, 'extra' => ''],
        ],
        'index_metadata' => [
            'PRIMARY' => ['unique' => true, 'columns' => ['id'], 'sub_parts' => [null], 'type' => 'BTREE'],
            'landing_session' => ['unique' => true, 'columns' => ['landing_key', 'session_token'], 'sub_parts' => [null, null], 'type' => 'BTREE'],
            'service_key' => ['unique' => false, 'columns' => ['service_key'], 'sub_parts' => [null], 'type' => 'BTREE'],
            'provider_key' => ['unique' => false, 'columns' => ['provider_key'], 'sub_parts' => [null], 'type' => 'BTREE'],
            'flow_key' => ['unique' => false, 'columns' => ['flow_key'], 'sub_parts' => [null], 'type' => 'BTREE'],
            'pid' => ['unique' => false, 'columns' => ['pid'], 'sub_parts' => [null], 'type' => 'BTREE'],
            'click_id' => ['unique' => false, 'columns' => ['click_id'], 'sub_parts' => [null], 'type' => 'BTREE'],
            'tksource' => ['unique' => false, 'columns' => ['tksource'], 'sub_parts' => [null], 'type' => 'BTREE'],
            'tkzone' => ['unique' => false, 'columns' => ['tkzone'], 'sub_parts' => [null], 'type' => 'BTREE'],
            'updated_at' => ['unique' => false, 'columns' => ['updated_at'], 'sub_parts' => [null], 'type' => 'BTREE'],
            'is_soft_flag_updated' => ['unique' => false, 'columns' => ['is_soft_flag', 'updated_at', 'id'], 'sub_parts' => [null, null, null], 'type' => 'BTREE'],
            'created_landing_session' => ['unique' => false, 'columns' => ['created_at', 'landing_key', 'session_token'], 'sub_parts' => [null, null, null], 'type' => 'BTREE'],
        ],
    ],
    ...
    'kiwi_sms_body_variant_assignments' => [
        ...
        // Only these explicitly selected details participate in general deployment.
        'deployment_details' => ['columns' => ['allocation_version'], 'indexes' => []],
        'migration_required_on_drift' => true,
        'column_metadata' => ['allocation_version' => ['type' => 'varchar(50)', 'nullable' => false, 'default' => 'legacy', 'extra' => '']],
    ],
    'kiwi_sms_body_variant_summary' => [
        ...
        // Only these explicitly selected details participate in general deployment.
        'deployment_details' => ['columns' => ['allocation_version'], 'indexes' => ['variant_summary']],
        'migration_required_on_drift' => true,
        'column_metadata' => ['allocation_version' => ['type' => 'varchar(50)', 'nullable' => false, 'default' => 'legacy', 'extra' => '']],
        'index_metadata' => ['variant_summary' => ['unique' => true, 'columns' => ['landing_key', 'service_key', 'variant_key', 'seed', 'allocation_version'], 'sub_parts' => [null, null, null, null, null], 'type' => 'BTREE']],
        'deployment_unique_indexes' => ['PRIMARY', 'variant_summary'],
    ],
