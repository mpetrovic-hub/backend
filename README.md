...
Scope:
- Protected: plugin frontend tools (`kiwi_hlr_lookup`, `kiwi_dimoco_refunder`, `kiwi_dimoco_blacklister`, `kiwi_landing_pages_gallery`, `kiwi_premium_sms_fraud`, `kiwi_statistics`) and HLR/statistics export triggers.
